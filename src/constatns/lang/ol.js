export default {
    WELCOME_TO_LETSCHAT:"Welcome to Letschat",
    READ_OUR:"Read our",
    ...
    DONE:"Done",
    LETSCHAT_WILL_SEND:"Letschat will send and sms message to verify your phone number.",
    ...
    YOU_CAN_CHAT_WITH_CONTACTS:"You can chat with contacts who have Letschat installed and signup on their phone.",
    CHATS:"Chats",
    CANCEL:"Cancel",
    NEW_CHAT:"New Chat",
    SEARCH:"Search",
